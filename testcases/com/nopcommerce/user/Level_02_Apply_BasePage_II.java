...
public class Level_02_Apply_BasePage_II {
  ...
  public void TC_01_Register_Empty_Data() {
	  basePage.waitForElementClickEnable(driver,  "//a[@class='ico-register']");
	  basePage.clickToElement(driver, "//a[@class='ico-register']");
	  basePage.waitForElementClickEnable(driver,  "//button[@id='register-button']");
  ...
  public void TC_03_Register_Success() {
	  ...
	  basePage.waitForElementClickEnable(driver,  "//a[@class='ico-logout']");
  ...
  public void TC_06_Register_Invalid_Confirm_Password() {
	  ...
	  basePage.sendkeyToElement(driver, "//input[@id='LastName']", "FC");
	  basePage.sendkeyToElement(driver, "//input[@id='Email']", emailAddress);
	  basePage.sendkeyToElement(driver, "//input[@id='Password']", "126663");
	  basePage.sendkeyToElement(driver, "//input[@id='ConfirmPassword']", "124443");
