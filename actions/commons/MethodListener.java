...
public class MethodListener implements IInvokedMethodListener {
	...
	public void afterInvocation(IInvokedMethod method, ITestResult result) {
		...
		Reporter.setCurrentTestResult(result);//set trạng thái
		if (method.isTestMethod()) { //nếu là testMethod thì get tât cả lỗi ra
			...
			//tạo ra 1 list get tất cả kết quả fail ra
