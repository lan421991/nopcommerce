...
public class ProductDetailPageUI {
	...
	public static final String ALT_TEXTBOX_ADD_NEW= "ID=AddPictureModel_OverrideAltAttribute";
	public static final String TITLE_TEXTBOX_ADD_NEW = "id=AddPictureModel_OverrideTitleAttribute";
	...
	public static final String DELETE_BUTTON_BY_IMAGE_TITLE = "xpath=//td[text()='%s']/following-sibling::td[contains(string(),'Delete')]";
}
