...
public class HomePageUI {
	...
	public static final String PAGING_BY_NUMBER_ACTIVE = "xpath=//a[@class='qgrd-pagination-page-link active' and text()='%s']";
	public static final String HEADER_TEXT_BY_NAME = "xpath=//div[@class='qgrd-header-text' and text()='%s']/parent::div/following-sibling::input";
	...
	public static final String ACTION_BUTTON_BY_ROW_INDEX = "xpath=//tr[%s]//button[@title='%s']";
